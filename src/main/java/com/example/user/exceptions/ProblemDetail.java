...
public class ProblemDetail {
	 ...
	 * <p>
	 * By default, if not explicitly set and the status is well-known, this is
	 ...
	 * properties map}.
	 * <p>
	 * When Jackson JSON is present on the classpath, any properties set here are
	 * rendered as top level key-value pairs in the output JSON. Otherwise, they are
	 * rendered as a {@code "properties"} sub-map.
	 * 
	 * @param name  the property name
	 * @param value the property value, possibly {@code null} if the intent is to
	 *              include a property with its value set to "null"
	 ...
	 * {@code null} if no properties have been added. To add a property, use
	 * {@link #setProperty(String, Object)}.
	 * <p>
	 * When Jackson JSON is present on the classpath, the content of this map is
	 * unwrapped and rendered as top level key-value pairs in the output JSON.
	...
	public boolean equals(@Nullable Object other) {
		...
		return Objects.equals(getType(), that.getType()) && Objects.equals(getTitle(), that.getTitle())
				&& this.status == that.status && Objects.equals(this.detail, that.detail)
				&& Objects.equals(this.instance, that.instance) && Objects.equals(this.properties, that.properties);
	}

	@Override
	public int hashCode() {
		return Objects.hash(this.type, getTitle(), this.status, this.detail, this.instance, this.properties);
	}
	...
	protected String initToStringContent() {
		return "type='" + getType() + "'" + ", title='" + getTitle() + "'" + ", status=" + getStatus() + ", detail='"
				+ getDetail() + "'" + ", instance='" + getInstance() + "'" + ", properties='" + getProperties() + "'";
	}
	 ...
	 */
	public static ProblemDetail forStatusAndDetail(HttpStatus status, @Nullable String detail) {
		Assert.notNull(status, "HttpStatusCode is required");
